...
void Taxi::actualizar(std::vector<std::vector<Nodo>>& matrizNodos, std::vector<int> nodoActual, bool distancia, int x, int y) {
  matrizNodos[nodoActual[0] + x][nodoActual[1] + y].set_h(Heuristica(distancia, nodoActual[0] + x, nodoActual[1] + y));
  matrizNodos[nodoActual[0] + x][nodoActual[1] + y].set_coste(10 + matrizNodos[nodoActual[0]][nodoActual[1]].get_g());
      ...
      if (pertenece == 0) {
        ...
        if (pertenece) {
          if (matrizNodos[nodoActual[0] - 1][nodoActual[1]].get_g() > 10 + matrizNodos[nodoActual[0]][nodoActual[1]].get_g()) {
            actualizar(matrizNodos, nodoActual, distancia, -1, 0);
          }
        }
        else {
          actualizar(matrizNodos, nodoActual, distancia, -1, 0);
      ...
      if (pertenece == 0) {
        ...
        if (pertenece) {
          if (matrizNodos[nodoActual[0]][nodoActual[1] + 1].get_g() > 10 + matrizNodos[nodoActual[0]][nodoActual[1]].get_g()) {
            actualizar(matrizNodos, nodoActual, distancia, 0, 1);
          }
        }
        else {
          actualizar(matrizNodos, nodoActual, distancia, 0, 1);
      ...
      if (pertenece == 0) {
        ...
        if (pertenece) {
          if (matrizNodos[nodoActual[0] - 1][nodoActual[1] + 1].get_g() > 14 + matrizNodos[nodoActual[0]][nodoActual[1]].get_g()) {
            actualizar(matrizNodos, nodoActual, distancia, -1, +1);
          }
        }
        else {
          actualizar(matrizNodos, nodoActual, distancia, -1, +1);
